(module 
  ...
  (func $MixStdAndNonStd_printString (param i32) (result i32) 
    ;;> fn printString(str: String): Unit = {
    ;;|   printString(str);
    ;;|   printString(str)
    ;;| }
    ;;> printString(str)
  ...
  (export "MixStdAndNonStd_main" (func $MixStdAndNonStd_main))
  (func $MixStdAndNonStd_main (local i32)
    ;;> (
    ;;|   val intInput: Int(32) =
    ;;|     readInt();
    ;;|   printString(intToString(intInput))
    ;;| )
    ;;> readInt()
    call $Std_readInt
    local.set 0
    ;;> printString(intToString(intInput))
    ;;> intToString(intInput)
    ;;> intInput
    local.get 0
    call $Std_intToString
    call $MixStdAndNonStd_printString
    drop
  )
)