(module 
  ...
  (func $BasicConditions_neverTrigger (result i32) 
  ...
  (export "BasicConditions_main" (func $BasicConditions_main))
  (func $BasicConditions_main (local i32 i32)
    ;;> (
    ;;|   val c1: Boolean =
    ;;|     (true || neverTrigger());
    ;;|   val c2: Boolean =
    ...
    if (result i32)
      ...
      ;;> neverTrigger()
      call $BasicConditions_neverTrigger
    end
    local.set 0
    ;;> (
    ;;|   val c2: Boolean =
