...
void main() {
  ...
  //   printBoolean(true);
  //   printBoolean(false);
  //   printString(digitToString(0));
  //   printString(digitToString(5));
  //   printString(digitToString(9));
  //   printString(intToString(0));
  //   printString(intToString(-(111)));
  //   printString(intToString(22));
