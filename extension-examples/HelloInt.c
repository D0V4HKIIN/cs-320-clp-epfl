...
void main() {
  ...
  //   val name: String =
  //     readString();
  //   printString((("Hello " ++ name) ++ "! And how old are you?"));
  //   val age: Int(32) =
  //     readInt();
  //   printString((intToString(age) ++ " years old then."))
  // )
  // (
  //   val name: String =
  //     readString();
  ...
  setLocal(1);
  // printString((intToString(age) ++ " years old then."))
  // (intToString(age) ++ " years old then.")
  // intToString(age)
  // age
  getLocal(1);
  Std_intToString();
  // mkString:  years old then.
  getGlobal(0);
  cnst 0;
  push (pop + pop);
  cnst 32;
